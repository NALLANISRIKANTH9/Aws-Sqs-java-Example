...
public class SqsConfig {
    ...
    static {
        ...
        credentials = new BasicAWSCredentials("AKIAJKX43YAN", "jiL/daw/BwJK448FD0eO" );
    }
    ...
    public static void main(String[] args) {
        ...
        CreateQueueRequest createStandardQueueRequest = new CreateQueueRequest("Nallani-Queue");
        ...
        CreateQueueRequest createFifoQueueRequest = new CreateQueueRequest("Nallani-Queue.fifo").withAttributes(queueAttributes);
        String fifoQueueUrl = sqs.createQueue(createFifoQueueRequest).getQueueUrl();
        System.out.println(fifoQueueUrl);

        // Set up a dead letter queue
        String deadLetterQueueUrl = sqs.createQueue("Nallani-DL-Queue").getQueueUrl();
        ...
        SendMessageRequest sendMessageStandardQueue = new SendMessageRequest().withQueueUrl(standardQueueUrl)
            .withMessageBody("Hi, Hello how are you.!!!!")
        ...
        SendMessageRequest sendMessageFifoQueue = new SendMessageRequest().withQueueUrl(fifoQueueUrl)
            ...
            .withMessageGroupId("Nallani-group-1")
            .withMessageAttributes(messageAttributes);
